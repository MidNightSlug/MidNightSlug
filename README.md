...
В ходе выполнения данной лаболаторой работе мы ознакомились с программными средствами для организции передачи данных между инструментами google, Python и Unity
